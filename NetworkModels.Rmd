...
As we expect, the *Dissortative mixing* is captured and "*Characterized pyramidal neuron*" have more chances to form a ties (which is true because they start the synapses). More precisely, the probability is `r sprintf("%.2f", exp(4.129396))` higher respect to a "*Cell body in EM volume*".
